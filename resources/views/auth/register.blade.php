                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="no_hp" type="tel" pattern="[0][8][0-9]{10,11}" class="form-control @error('email') is-invalid @enderror" name="no_hp" value="{{ old('no_hp') }}" required autocomplete="no_hp">
                        ...
                        <div class="form-group row">
                            <label for="no_hp" class="col-md-4 col-form-label text-md-right">Jenis Kelamin</label>
